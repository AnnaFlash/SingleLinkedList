// SingleLinkedList.cpp: определяет точку входа для приложения.
//
...
public:
    ...
    [[nodiscard]] Iterator end() noexcept {
        BasicIterator<value_type> end_(nullptr);
        return end_;
    }
    ...
    SingleLinkedList(It begin, It end) {
    ...
    Iterator InsertAfter(ConstIterator pos, const Type& value) {
        ...
        ++size_;
        BasicIterator<value_type> new_next(new_node);
        return { new_next };
    }
    /*
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        ...
        --size_;
        pos.node_->next_node = next_next_node;
        BasicIterator<value_type> new_next(pos.node_->next_node);
        return { new_next };
    }
private:
